...
def build_pdf(output_path):
    ...
    top_items = [
        ('마법의 통호밀빵', '100g', 204, 22, 0, 28, 1.2, '단백질 28g으로 혈당 상승 억제 최우수'),
    ...
    notes = [
        ...
        '※ 녹색 제품(마법의 쑥식빵, 마법의 통호밀빵, 프로틴파운드, 프로틴 식빵)은 밀단백질/유청단백질 강화 제품으로 탄수화물-단백질 비율이 유리합니다.',
        '※ 노란색 제품은 소량씩 채소·달걀 등 단백질 식품과 함께 섭취하면 혈당 상승을 완화할 수 있습니다.',
        '※ 설탕무첨가 단팥빵/말차 단팥빵은 스테비아(천연 감미료)를 사용하여 당류 0g이나, 탄수화물(54g/160g)이 높으니 절반씩 나눠 드세요.',
        '※ 크림치즈 팥빵류는 트랜스지방(0.3g)이 함유되어 있어 당뇨 환자에게 권장하지 않습니다.',
